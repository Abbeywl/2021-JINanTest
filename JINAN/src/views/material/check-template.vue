<template>
  <div class="root">
    <div class="search">
      <el-input placeholder="请输入模板名称" v-model="keyword" clearable class="input-with-select">
    ...
    >
      ...
      <el-table-column label="操作" align="right">
        <div slot-scope="scope">
          <el-button @click="deleteTemplate(scope.row.id)" size="small" type="danger" round>删除</el-button>
          <el-button
    ...
    ></el-pagination>
    <el-upload class="upload template" action="http://219.228.76.43:8886/upload" :headers="headers" :on-success="uploadSuccess">
